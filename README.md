...
- 💻 Atualmente estou trabalhando com ciência de dados, principalmente relacionado a indústria 4.0
- 🖥️ Sólidos conhecimentos em python, inteligência artificial, automação industrial, aprendizado de máquina, redes neurais, etc.
- 🛠️ Sólidos conhecimentos com programação de CLPs (WAGO, Schneider, Altus, etc)
<br/>
